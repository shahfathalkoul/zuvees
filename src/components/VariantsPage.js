          ...
          <div className="flex h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-white shadow-md">
              ...
              <nav className="mt-6">
                ...
                <a href="/raw" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Raw Materials</a>
                <a href="/variant" className="block px-4 py-2 bg-blue-500 text-white">Product Variant</a>
              </nav>
            </aside>
                      ...
                      <tbody>
                        {currentProducts.map((product) => (
                          <tr key={product.id}>
                            ...
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              <img src={product.image} alt={product.name} className="h-12 w-12 rounded-full" />
                            </td>
                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                              {/* <button 
